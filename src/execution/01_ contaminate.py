...
for col in cols_to_contaminate:
    if df[col].dtype in ['int64', 'float64']:  # SOLO COLUMNAS NUMÉRICAS
        ...
        # - el tamaño del ruido se adapta a la variabilidad natural de los datos, desviacion estándar * NOISE_INTENSITY: magnitud relativa del ruido.
        ...
        if OPERACION_RUIDO == 'SUMA':
            # SUMAR RUIDO A COLUMNAS, SIMULA ANOMALÍAS O VARIACIONES NATURALES EN LOS DATOS
