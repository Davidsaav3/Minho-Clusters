...
N_CLUSTERS_LIST = [2, 3, 4]               # LISTA DE N_CLUSTERS PARA KMEANS, MINI-BATCH Y BIRCH
EPS_DBSCAN_LIST = [5.0, 6.0, 7.0]         # LISTA DE EPS A PROBAR EN DBSCAN
MIN_SAMPLES_DBSCAN_LIST = [30, 50, 75, 100, 150]  # LISTA DE MIN_SAMPLES A PROBAR EN DBSCAN
BATCH_SIZE_LIST = [5000, 10000]           # LISTA DE TAMAÑOS DE LOTE PARA MINI-BATCH Y BIRCH
