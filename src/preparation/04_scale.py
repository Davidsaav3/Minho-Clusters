...
if SCALER_TYPE == 'standard':
    ...
    # NORMALIZA LAS FEATURES: RESTA LA MEDIA Y DIVIDE POR LA DESVIACIÓN ESTÁNDAR DE CADA COLUMNA
    # COMO RESULTADO, CADA FEATURE TIENE MEDIA ≈ 0 Y DESVIACIÓN ESTÁNDAR ≈ 1 (VALORES ENTRE -3 Y +3 EN PROMEDIO)
    # ESTE ESCALADO REDUCE EL DOMINIO DE VARIABLES CON MAGNITUDES DIFERENTES Y EVITA QUE DOMINEN EL MODELO
    # ES ESPECIALMENTE ADECUADO PARA DATOS APROXIMADAMENTE NORMALES Y ALGORITMOS SENSIBLES A LA ESCALA
    # (EJ. ISOLATION FOREST, PCA, K-MEANS O REDES NEURONALES)
