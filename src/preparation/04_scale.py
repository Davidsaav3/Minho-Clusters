...
if SCALER_TYPE == 'standard':
    ...
    # ESTE ESCALADO REDUCE VARIABLES CON MAGNITUDES DIFERENTES Y EVITA QUE DOMINEN EL MODELO
    # ES ESPECIALMENTE ADECUADO PARA DATOS NORMALES Y ALGORITMOS SENSIBLES A LA ESCALA como IF, PCA, K-MEANS O REDES NEURONALES
